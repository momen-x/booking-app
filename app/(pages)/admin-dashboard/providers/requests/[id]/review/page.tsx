...
import AddProviderForm from "@/app/_modules/providers/views/add-provider";
...
const ReviewProviderRequestPage = async ({ searchParams }: PageProps) => {
  ...
  if (!userId || !name) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] bg-zinc-50 dark:bg-black">
        <div className="bg-white dark:bg-zinc-900 p-8 rounded-2xl shadow-sm border border-red-200 dark:border-red-800">
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-zinc-50 via-white to-zinc-50 dark:from-black dark:via-zinc-950 dark:to-black p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-2xl border shadow-sm p-6 mb-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-1 sm:grid-cols-1 md:grid-cols-1 gap-6">
          <div className="bg-white dark:bg-zinc-900 rounded-2xl border-2 border-green-800 dark:border-green-800 shadow-lg shadow-green-100/20 dark:shadow-green-900/20 overflow-hidden">
            <div className="px-6 py-4 bg-linear-to-r from-green-50 to-emerald-50 dark:from-green-950/30 dark:to-emerald-950/30 border-b border-green-800 dark:border-green-800">
              <div className="flex items-center gap-3">
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-2xl border-2 border-red-200 dark:border-red-800 shadow-lg shadow-red-100/20 dark:shadow-red-900/20 overflow-hidden">
            ...
            <div className="p-6">
              <AddNotificationForm userId={userId} />
            </div>
          </div>
        </div>
