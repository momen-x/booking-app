...
import { TUpdateService, updateServiceSchema } from "../dto/update-service";
import { serviceSchema, TService } from "../dto/add-service";
...
const ServiceForm = ({ goal, id, service, description }: TServiceProps) => {
  ...
  const { mutate: handleCreate, isPending: isCreating } = useAddService();
